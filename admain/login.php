...
$row1=mysqli_fetch_assoc($result);
 ...
 if(!empty($row1['admin_id'])){
$_SESSION['id']=$row1['admin_id'];
$_SESSION['adname']=$row1['fullname'];
$_SESSION['ademail']=$row1['admin_email'];
            ...
            <div class="container">
                <div class="login-wrap">
                    <div class="login-content">
                     ...
                     <p style="color:white;background-color:#B22222;">   <?php if(isset($error)) echo $error; ?></p>
